...
import { confpopoff, confpopon } from "./features/PopupSlice";
...
const CustomModal = (movie, PopupInfo) => {
                ...
                <div className="modal">
                    ...
                    <div className="actions">
                            ...
                            <div className="menu">
                                ...
                                >
                                    <div className="menu">
                                        ...
                                        <div className="menu-item"> iteEm 2</div>
                        ...
                        <button
                            className="button"
                            onClick={() => {
                                dispatch(confpopoff(false));
                                console.log("msdodal closed ");
